                ...
                <div className="contactformp">
                    <div className="leftcontp">
                        ...
                        <div className="leftsociinfo">
                            <ul>
                                <li><FaPhoneVolume /> <span>Phone: <a href="tel:+123456789" rel="nofollow" target="_blank">+91-123456789</a></span></li>
                                <li><MdAttachEmail /> <span>Email: <a href="mailto:info@vbmcoder.me" rel="nofollow" target="_blank">info@vbmcoder.me</a></span></li>
                                <li><GrLinkedin /> <span>Linkedin: <a href="https://www.linkedin.com/in/lovette-nkayi/" rel="nofollow" target="_blank">Vaibhav mak</a></span></li>
                                <li><FaTwitter /> <span>Twitter: <a href="http://twitter.com/vbmcoder" rel="nofollow" target="_blank">@vbmcoder</a></span></li>
                            </ul>
                        </div>
                    </div>
